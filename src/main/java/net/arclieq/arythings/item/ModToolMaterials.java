...
public enum ModToolMaterials implements ToolMaterial {
   NETIAMOND(ModTags.Blocks.INCORRECT_FOR_NETIAMOND_TOOL, 3592, 13.0F, 5.5F, 12, () -> {
      return Ingredient.ofItems(new ItemConvertible[]{ModItems.NETIAMOND});
   }),

   LUMIT(ModTags.Blocks.INCORRECT_FOR_LUMIT_TOOL, 2076, 8.9F, 4.1F, 16, () -> {
      return Ingredient.ofItems(new ItemConvertible[]{ModItems.LUMIT_SHARD});
   }),

   MYTHRIL(ModTags.Blocks.INCORRECT_FOR_MYTHRIL_TOOL, 1535, 6.8F, 3.0F, 17, () -> {
      return Ingredient.ofItems(new ItemConvertible[]{ModItems.MYTHRIL_INGOT});
   }),

   ZAZUM(ModTags.Blocks.INCORRECT_FOR_ZAZUM_TOOL, 1862, 8.84F, 3.95F, 16, () -> {
      return Ingredient.ofItems(new ItemConvertible[]{ModItems.ZAZUM_INGOT});
   }),
   
   LUZZANTUM(ModTags.Blocks.INCORRECT_FOR_LUZZANTUM_TOOL, 1731, 8.7F, 3.8F, 15, () -> {
