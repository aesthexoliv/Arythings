...
public class NetiamondShovelItem extends ShovelItem {

    public NetiamondShovelItem(ToolMaterial material, Settings settings) {
        super(material, settings);
    }

    // Shovel right click method (adds Haste II and NV when SHIFT + Right click, adds ... when CTRL + Right click, etc.)
    @Override
