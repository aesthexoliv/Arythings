...
public class ModItemGroups {
    ...
    .entries((displayContext, entries) -> {
        ...
        entries.add(ModItems.ZAZUM_INGOT);
        ...
        entries.add(ModBlocks.ZAZUM_BLOCK);
        entries.add(ModBlocks.ZAZUM_ORE);
        entries.add(ModBlocks.DEEPSLATE_ZAZUM_ORE);
    ...
    .entries((displayContext, entries) -> {
        ...
        entries.add(ModItems.ZAZUM_SWORD);
        ...
        entries.add(ModItems.ZAZUM_HELMET);
        entries.add(ModItems.ZAZUM_CHESTPLATE);
        entries.add(ModItems.ZAZUM_LEGGINGS);
        entries.add(ModItems.ZAZUM_BOOTS);
    ...
    .entries((displayContext, entries) -> {
        ...
        entries.add(ModItems.ZAZUM_PICKAXE);
        entries.add(ModItems.ZAZUM_AXE);
        entries.add(ModItems.ZAZUM_SHOVEL);
        entries.add(ModItems.ZAZUM_HOE);

        entries.add(ModItems.UPGRADED_LUZZANTUM_PICKAXE);
        entries.add(ModItems.UPGRADED_LUZZANTUM_AXE);
        entries.add(ModItems.UPGRADED_LUZZANTUM_SHOVEL);
        entries.add(ModItems.UPGRADED_LUZZANTUM_HOE);
        ...
        entries.add(ModItems.UPGRADED_LUMIT_PICKAXE);
        entries.add(ModItems.UPGRADED_LUMIT_AXE);
        entries.add(ModItems.UPGRADED_LUMIT_SHOVEL);
        entries.add(ModItems.UPGRADED_LUMIT_HOE);
